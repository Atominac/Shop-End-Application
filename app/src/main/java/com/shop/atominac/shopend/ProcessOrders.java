...
public class ProcessOrders extends Fragment {

    protected View mView;
    private static final String TAG = "myOrders";
    RecyclerView recyclerView ;
    private List<ProcessOrderModel> activityList = new ArrayList<>();
    private ProcessOrderAdapter mAdapter;
    ProcessOrderModel activityItems;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_processorders, container, false);
        this.mView = view;
        ...
        mAdapter = new ProcessOrderAdapter(activityList, getActivity());
    ...
    void ProcessOrderListApiCall(){
        showProgress();
        RequestQueue queue = Volley.newRequestQueue(getActivity());
        String api = "https://homebuddy2018.herokuapp.com/viewPendingOrders/viewProgressOrders";
                ...
                for (int i = 0; i <=jsonArray.length(); i++) {
                    try {
                        ...
                        if (!jsonArray.toString().equals("[]")){
                            ...
                            activityItems = new ProcessOrderModel(coustmer_name , coustmer_address, "Bill amount : Rs " + bill ,payment,itemList,finaldatetime,status,order_id);
