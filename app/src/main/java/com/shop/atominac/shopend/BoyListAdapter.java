...
class BoyListAdapter extends RecyclerView.Adapter<BoyListAdapter.ViewHolder>{
    ...
    BoyListAdapter(List<Delivery_boy_model> activityList, Context context, String orderId) {
    ...
    @Override
    public BoyListAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.delivery_boy_model, parent, false);
        pDialog = new ProgressDialog(mContext);
        pDialog.setMessage("Please wait...");
        pDialog.setCancelable(false);
        return new BoyListAdapter.ViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(BoyListAdapter.ViewHolder holder, int position) {
